...
- Consumer projects should use the proxied archive URL format: `https://proxy.cbotomo.com/https://github.com/Lyrik-AI/lyra-python-sdk/archive/refs/tags/vX.Y.Z.zip`.
